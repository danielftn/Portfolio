...
export default function Header() {
  return (
    <header className="z-[999] relative">
        ...
        bg-white bg-opacity-80 shadow-ig shadow-black/[0.03] backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] sm:w-[36rem] sm:rounded-full'
            ...
            sm:flex-nowrap sm:gap-5'>
                {
                    links.map(link => (
                        ...
                        animate={{y: 0, opacity: 1}}>
                            ...
                            px-3 py-3 hover:text-gray-950' href={link.hash}>
                                {link.name}
                            </Link>
                        </motion.li>
                    ))
